...
WAYPOINTS_FILENAME = 'Course4FinalProject/course4_waypoints.txt'  # waypoint file to load
...
C4_STOP_SIGN_FILE        = 'Course4FinalProject/stop_sign_params.txt'
C4_STOP_SIGN_FENCELENGTH = 5        # m
C4_PARKED_CAR_FILE       = 'Course4FinalProject/parked_vehicle_params.txt'
...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        config.read(os.path.join(
                os.path.dirname(os.path.realpath(__file__)), 'Course4FinalProject/options.cfg'))         
